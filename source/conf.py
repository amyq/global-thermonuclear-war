...
# At the top. (added from http://sphinx-bootstrap-theme.readthedocs.io/en/latest/README.html
...
rst_prolog = open("_includes/acquia-products.txt", "r").read()
rst_prolog += open("_includes/acquia-logos.txt", "r").read()
